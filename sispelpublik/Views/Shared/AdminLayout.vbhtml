...
<head>
    ...
    <title>@ViewData("Title") - SIIP Admin</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <span class="sidebar-brand brand-logo text-white" style="font-weight: bold; ">Admin Panel</span>
                <span class="sidebar-brand brand-logo-mini text-white" style="font-weight: bold; margin-left: 5%;">A</a>
            </div>
            <ul class="nav">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            ...
                            <div class="profile-name">
                                <h5 class="mb-0 font-weight-normal">Firman Raiwan</h5>
                                <span>Administrator</span>
                            </div>
                        </div>
                </li>
                <li class="nav-item nav-category">
                    <span class="nav-link">Menu Navigasi</span>
                </li>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#surat" aria-expanded="false" aria-controls="ui-basic">
                        <span class="menu-icon">
                    ...
                    <div class="collapse" id="surat">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="#">Data Surat</a></li>
                            <li class="nav-item"> <a class="nav-link" href="#">Log Surat</a></li>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#halaman" aria-expanded="false" aria-controls="ui-basic">
                        <span class="menu-icon">
                            <i class="mdi mdi-laptop"></i>
                        </span>
                    ...
                    <div class="collapse" id="halaman">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="#">Tambah Halaman</a></li>
                            <li class="nav-item"> <a class="nav-link" href="#">Daftar Halaman</a></li>
        ...
        <div class="container-fluid page-body-wrapper">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                <div class="navbar-profile">
                                    <img class="img-xs rounded-circle" src="~/Assets/Admin/images/faces/face15.jpg" alt="">
                                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Firman Raiwan</p>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                                ...
                                <div class="dropdown-item preview-item">
                                    ...
                                    <div class="preview-item-content">
                                        <a href="~/Admin/Login" class="preview-subject mb-1">Log out</a>
                                    </div>
                                </div>
                        </li>
                    </ul>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © SIPP Kelompok 9 2022</span>
                    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Dibuat dengan penuh cinta dari kelompok 9</span>
                </div>
            </footer>
            <!-- partial -->
        </div>
